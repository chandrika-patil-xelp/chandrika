		  ...
		  if(dt['basicDetails']['default_image']!== null){
             ...
             $(basic).each(function(i, vl) {
               ...
               switch(type){
                   ...
                   case 1:
                    {
                        Nstr+= '<span> , <span>Solitaire</span></span>'; 
                        break;
                    }
                    case 2:
                    {
                        Nstr+= '<span> ,<span>Diamond</span></span>'; 
                        break;
                    }
                    case 3:
                    { 
                    ...
                    {
                         var gemstn = gemstone.results[0].gemNm; 
                        Nstr+= '<span> ,<span> '+gemstn+' /span></span>'; 
                        break;
                    }
                     case 6:
                    {
                        Nstr+= '<span> ,<span> Gemstones </span></span>'; 
                        break;
                    }
                     case 7:
                    {
                         gemstn = gemstone.results[0].gemNm; 
                        Nstr+= '<span> ,<span>Diamond,'+gemstn+'</span></span>'; 
                        break;
                    }
                    
                    case 8:
                    {
                        Nstr+= '<span> ,<span>Diamond,Gemstones</span></span>'; 
                        break;
                    }
