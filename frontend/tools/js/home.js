...
$('.side-borh').velocity({height: [0], width: ['82%']}, {delay: 0, duration: 0});
...
function test(){
    ...
    var _this=$('.prdctAdd1 ');
    $(_this).find('.p_cont').addClass('fadeI');
    $(_this).find('.p_cont2').addClass('fadeU');
    $(_this).find('.top-bor').addClass('bor-hover1');
    $(_this).find('.side-bor').addClass('bor-hover2');
    $(_this).find('.side-borh').addClass('bor-hover2h');
    $(_this).find('.effect1').addClass('eff1_trigger').removeClass('eff1_triggerR');
    $('.bor-hover1').velocity({width: ['88%', '0']}, {duration: 300, easing: "ease-in-out"});
    $('.bor-hover2').velocity({height: ['88%', '0']}, {duration: 300, easing: "ease-in-out"});
    $('.bor-hover2h').velocity({height: ['95%', '0']}, {duration: 300, easing: "ease-in-out"});
    $('.fadeI').velocity({opacity: [1, 0], translateY: [0, -50]}, {duration: 400, easing: "ease-in-out"});
...
$('.prdctAdd1').mouseleave(function() {
    ...
    $('.bor-hover2h').velocity('reverse');
    $(this).find('.top-bor').removeClass('bor-hover1');
    $(this).find('.side-borh').removeClass('bor-hover2h');
...
$('.middleDiv').mouseenter(function() {
    $(this).find('.top-bor').addClass('bor-hover1');
    $(this).find('.side-borh').addClass('bor-hover2h');
    $(this).find('.p_cont2').addClass('trUp');
//$(this).find('.img_cont').velocity({scale:[0.8,1]}, { duration:300, easing:"ease-in-out"});
    $('.trUp').velocity({translateY: [-50, 0]}, {duration: 300, easing: "ease-in-out"});
    $('.bor-hover1').velocity({width: ['88%', '0']}, {duration: 300, easing: "ease-in-out"});
    $('.bor-hover2h').velocity({height: ['95%', '0']}, {duration: 300, easing: "ease-in-out"});

});
$('.middleDiv').mouseleave(function() {
    $('.bor-hover1').velocity('reverse');
    $('.bor-hover2h').velocity('reverse');
    $('.trUp').velocity('reverse');
    $(this).find('.p_cont2').removeClass('trUp');
    $(this).find('.top-bor').removeClass('bor-hover1');
    $(this).find('.side-borh').removeClass('bor-hover2h');
});
