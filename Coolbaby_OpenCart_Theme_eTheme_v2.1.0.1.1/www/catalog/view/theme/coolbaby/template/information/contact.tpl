            ...
            <div class="row">
                <div class="<?php echo ($column_right ? 'col-md-4' : 'col-md-12'); ?>">
                    ...
                    <ul class="menu menu-icon">
                        ...
                        <?php if ($geocode) { ?>
                            <li><a href="https://maps.google.com/maps?q=<?php echo urlencode($geocode); ?>&hl=<?php echo $geocode_hl; ?>&t=m&z=15" target="_blank" class="btn btn-info"><i class="fa fa-map-marker"></i> <?php echo $button_map; ?></a></li>
                        <?php } ?>
                    </ul>
                </div>
