...
class vendor extends DB
{
    ...
    public function getVproductsByName($params)
    {
     ...
     $sql1="SELECT 
                        ...
                        product_brand,
                        product_image,
                        IF(product_name LIKE '".$params['prname']."%',1,0) AS startwith,
                        IF(product_name LIKE '".$params['prname']."%',1,0) AS phrasematch,
                        designer_name 
            FROM 
                        tbl_product_master 
            WHERE
     ...
     if (!empty($page))
    {
     ...
     if($chkcnt>0)
     {
        ...
        {   $i++;
            ...
            $pdet['prod_img']=$row['product_image'];
            $prDetails[]=$pdet;
        }
    ...
    public function getVDetailByVidPid($params)
    {
        ...
        if($chkcnt>0)
        {
            ...
            $sql2="SELECT 
                            ...
                            other_bdbc as other_Diamond_Certificate,
                            vatno as Vat_Number,                            
                            landline,
                            mdbw as diamond_around_world,                            
                            website,
                            banker as bankers,                            
                            pancard,
                            turnover,
