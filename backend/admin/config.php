...
{
	define('HTTP_SERVER', 'http://beta.xelpmoc.in/jzeva/backend/admin/');
	define('HTTP_CATALOG', 'http://beta.xelpmoc.in/jzeva/backend/');

	// HTTPS
	define('HTTPS_SERVER', 'http://beta.xelpmoc.in/jzeva/backend/admin/');
	define('HTTPS_CATALOG', 'http://beta.xelpmoc.in/jzeva/backend/');

	// DIR
	define('DIR_APPLICATION', '/usr/share/nginx/html/jzeva/backend/admin/');
	define('DIR_SYSTEM', '/usr/share/nginx/html/jzeva/backend/system/');
	define('DIR_LANGUAGE', '/usr/share/nginx/html/jzeva/backend/admin/language/');
	define('DIR_TEMPLATE', '/usr/share/nginx/html/jzeva/backend/admin/view/template/');
	...
	define('DIR_CATALOG', '/usr/share/nginx/html/jzeva/backend/catalog/');
}
else
{
	...
	// DIR
	define('DIR_APPLICATION', 'C:/xampp/htdocs/jzeva/backend/admin/');
	define('DIR_SYSTEM', 'C:/xampp/htdocs/jzeva/backend/system/');
	define('DIR_LANGUAGE', 'C:/xampp/htdocs/jzeva/backend/admin/language/');
	define('DIR_TEMPLATE', 'C:/xampp/htdocs/jzeva/backend/admin/view/template/');
	...
	define('DIR_CATALOG', 'C:/xampp/htdocs/jzeva/backend/catalog/');
}
// DB
